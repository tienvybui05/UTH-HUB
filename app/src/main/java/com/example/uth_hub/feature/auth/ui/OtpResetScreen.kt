...
import com.example.uth_hub.feature.auth.ui.component.CountdownText
import com.example.uth_hub.feature.auth.ui.component.OtpBoxes
import com.example.uth_hub.feature.auth.ui.component.PrimaryButton
import com.example.uth_hub.feature.auth.viewmodel.OtpResetViewModel
...
fun OtpResetScreen(
    ...
    onVerified: () -> Unit,
    onResend: () -> Unit = {},
    vm: OtpResetViewModel = viewModel()
) {
        ...
        Column(Modifier.fillMaxWidth().padding(horizontal = 16.dp)) {
            ...
            Box(Modifier.offset(y = (-20).dp)) {
                AuthCard {
                    ...
                    Text(text= "Nhập mã OTP đã gửi tới – $email",
                        textAlign = TextAlign.Center,
                        modifier = Modifier.fillMaxWidth())
...
@Composable
private fun PreviewOtpResetScreen() {
    OtpResetScreen(email = "sv@uth.edu.vn", onVerified = {})
}
